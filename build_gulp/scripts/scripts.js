...
let button = $('form#edit button')
console.log(button);
button.click(function(){
    let inputs = $('form#edit input, select');
    let emptyInputs = [];
    ...
    if(incorrectInputs === 0){
        ...
        console.log(newData);
        console.log('Ща пошлю запрос ихихихи');
        $.ajax({
            type: "POST",
